package com.Objects
{
	...
	public class SkyboxCube extends Cube 
	{
		
		[Embed (source="/../assets/space_env_front.jpg")]
		private var BitmapFront : Class; 
		[Embed (source="/../assets/space_env_right.jpg")]
		private var BitmapRight : Class; 
		[Embed (source="/../assets/space_env_back.jpg")]
		private var BitmapBack : Class; 
		[Embed (source="/../assets/space_env_left.jpg")]
		private var BitmapLeft : Class; 
		[Embed (source="/../assets/space_env_bottom.jpg")]
		private var BitmapDown : Class; 
		[Embed (source="/../assets/space_env_top.jpg")]
